    ...
    if (typeof port_arg === 'number' || typeof port_arg === 'string' && /^\d+$/.test(port_arg)) {
        ...
        if (parsed.slashes) { // We require slashes
            ...
            if (parsed.protocol && parsed.protocol !== 'redis:') {
                _8c9‍.g.console.warn('node_redis: WARNING: You passed "' + parsed.protocol.substring(0, parsed.protocol.length - 1) + '" as protocol instead of the "redis" protocol!');
            }
                ...
                for (elem in parsed.query) {
                    ...
                    if (elem in options) {
                        if (options[elem] === parsed.query[elem]) {
                            _8c9‍.g.console.warn('node_redis: WARNING: You passed the ' + elem + ' option twice!');
                        } else {
