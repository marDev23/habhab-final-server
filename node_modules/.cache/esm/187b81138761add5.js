    ...
    sendReport() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.options.debugPrintReports) {
                _876‍.g.console.log(`Engine sending report: ${JSON.stringify(report.toJSON())}`);
            }
            ...
            if (this.options.debugPrintReports) {
                _876‍.g.console.log(`Engine report: status ${response.status}`);
            }
        });
    }
    stop() {
    ...
    sendReportAndReportErrors() {
        return this.sendReport().catch(err => {
            if (this.options.reportErrorFunction) {
                ...
                _876‍.g.console.error(err.message);
            }
        });
    }
    resetReport() {
