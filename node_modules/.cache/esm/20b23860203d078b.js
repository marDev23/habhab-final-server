"main";let Joi;_203‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);let shortid;_203‍.w("shortid",[["default",["shortid"],function(v){shortid=v}]]);let order,items,shipment,invoice,myMessage;_203‍.w("../schemas",[["order",["order"],function(v){order=v}],["items",["items"],function(v){items=v}],["shipment",["shipment"],function(v){shipment=v}],["invoice",["invoice"],function(v){invoice=v}],["myMessage",["myMessage"],function(v){myMessage=v}]]);let Order,OrderItem,Shipment,Invoice,Message,Cart,User,OrderType,OrderStatus,Product,ItemStatus,Address;_203‍.w("../models",[["Order",["Order"],function(v){Order=v}],["OrderItem",["OrderItem"],function(v){OrderItem=v}],["Shipment",["Shipment"],function(v){Shipment=v}],["Invoice",["Invoice"],function(v){Invoice=v}],["Message",["Message"],function(v){Message=v}],["Cart",["Cart"],function(v){Cart=v}],["User",["User"],function(v){User=v}],["OrderType",["OrderType"],function(v){OrderType=v}],["OrderStatus",["OrderStatus"],function(v){OrderStatus=v}],["Product",["Product"],function(v){Product=v}],["ItemStatus",["ItemStatus"],function(v){ItemStatus=v}],["Address",["Address"],function(v){Address=v}]]);let placeOrderMail;_203‍.w("../mail-template",[["placeOrderMail",["placeOrderMail"],function(v){placeOrderMail=v}]]);let Auth;_203‍.w("../auth",[["*",null,function(v){Auth=v}]]);
