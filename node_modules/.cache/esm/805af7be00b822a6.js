"main";var __assign = (this && this.__assign) || function () {
...
function mergeSchemasImplementation(_a) {
    ...
    if (!resolvers) {
        ...
        _00b‍.g.console.warn('Passing functions as resolver parameter is deprecated. Use `info.mergeInfo` instead.');
...
function createMergeInfo(allSchemas, fragments) {
    return {
        delegate: function (operation, fieldName, args, context, info, transforms) {
            _00b‍.g.console.warn('`mergeInfo.delegate` is deprecated. ' +
