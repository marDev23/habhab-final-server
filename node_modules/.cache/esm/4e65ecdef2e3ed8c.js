...
function processGraphQLRequest(config, requestContext) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (extensions && extensions.persistedQuery) {
            ...
            if (query === undefined) {
                query = yield config.persistedQueries.cache.get(`apq:${queryHash}`);
                if (query) {
                ...
                (() => __awaiter(this, void 0, void 0, function* () {
                    return (config.persistedQueries &&
                        config.persistedQueries.cache.set(`apq:${queryHash}`, query));
                }))().catch(error => {
                    _f2e‍.g.console.warn(error);
                });
            }
        }
        else if (query) {
        ...
        try {
            ...
            if (validationErrors.length > 0) {
                ...
                return sendResponse({
                    errors: validationErrors.map(validationError => apollo_server_errors_1.fromGraphQLError(validationError, {
                        errorClass: apollo_server_errors_1.ValidationError,
                    })),
                });
            }
            validationDidEnd();
