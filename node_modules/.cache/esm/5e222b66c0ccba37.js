"main";_c0c‍.x([["placeOrderMail",()=>placeOrderMail]]);let sender;_c0c‍.w("../mail",[["sender",["sender"],function(v){sender=v}]]);let MAIL_ADDRESS;_c0c‍.w("../config",[["MAIL_ADDRESS",["MAIL_ADDRESS"],function(v){MAIL_ADDRESS=v}]]);let Address,Product;_c0c‍.w("../models",[["Address",["Address"],function(v){Address=v}],["Product",["Product"],function(v){Product=v}]]);



       const placeOrderMail = async (user, orderNumber, args) => {
  const shipment = await Address.findById(args.addressId)
  _c0c‍.g.console.log(shipment)
  const { input } = args
  _c0c‍.g.console.log(input)
  const productInfoArray = input.map(x => x.productId)
  const productInfo = await Product.find({ _id: { $in: productInfoArray } })
  _c0c‍.g.console.log(productInfo)
  const placeOrderObj = {
    from: MAIL_ADDRESS,
    to: user.email,
    ...
    <head>
      ...
      <title>HabHab - Fastfood Restaurant Invoice</title>
        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
          <center>
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
              ...
              <tr>
                <td class="free-text">
                  We'll let you know as soon as your items had being deliver. To change or view your order, please view your account by clicking the button below.
                </td>
              </tr>
              <tr>
                <td class="button">
                              ...
                              <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                                <tr>
                                  <td class="mini-block">
                                    ...
                                    ${user.name} <br />
                                    <bold>${user.mobile}</bold>
                                    ${shipment.baranggay} <br />
                                    ${shipment.municipal} <br />
                                    ${shipment.province} <br />
                                    Philippines
                                  </td>
                                </tr>
                              </table>
                        ...
                        <td class="item-col item">
                          <table cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                              ...
                              ${productInfo.map((y) =>
    `<td class="product">
                                <span style="color: #4d4d4d; font-weight:bold;">${y.name}</span> <br />
                                Hot city looks
                              </td>`
  )}
                            </tr>
                      ...
                      <tr>
                        ...
                        <td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
                          ...
                          <span class="total-space">Delivery Fee</span> <br />
            ...
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
              <tr>
                <td style="padding: 25px 0 25px">
                  <strong>HabHab - Fastfood Restaurant</strong><br />
                  Libertad Tungawan, Zamboanga Sibugay <br />
                  Philippines <br /><br />
                </td>
              </tr>
            </table>
