"main";(function (global, factory) {
        ...
        test: function (directive) {
            ...
            if (willRemove) {
                if (!directive.arguments ||
                    ...
                    _444‍.g.console.warn('Removing an @connection directive even though it does not have a key. ' +
    ...
    function tryFunctionOrLogError(f) {
        try {
            ...
            if (_444‍.g.console.error) {
                _444‍.g.console.error(e);
            }
        }
    }
    ...
    function warnOnceInDevelopment(msg, type) {
        ...
        if (!haveWarned[msg]) {
            ...
            switch (type) {
                case 'error':
                    _444‍.g.console.error(msg);
                    break;
                default:
                    _444‍.g.console.warn(msg);
            }
        }
    }
