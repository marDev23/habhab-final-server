"main";_176‍.x([["order",()=>order],["items",()=>items],["shipment",()=>shipment],["invoice",()=>invoice]]);let Joi;_176‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);let JoiDate;_176‍.w("./date-ext",[["JoiDate",["JoiDate"],function(v){JoiDate=v}]]);
...
const datePlaced = JoiDate.format('MM-DD-YYYY,hh:mm A').label('date placed')
const datePickUp = JoiDate.format('MM-DD-YYYY,hh:mm A').label('date placed')
...
const invoiceNumber = Joi.string().required().label('invoice number')
  ...
  productId, orderId, itemStatusId, quantity, price
       ...
       const shipment = Joi.object().keys({
  orderId, addressId
})
