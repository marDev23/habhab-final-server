"main";_d2e‍.x([["order",()=>order],["items",()=>items],["shipment",()=>shipment],["invoice",()=>invoice]]);let Joi;_d2e‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);let JoiDate;_d2e‍.w("./date-ext",[["*",null,function(v){JoiDate=v}]]);
